...
import { addBlanket } from "../../../actions/blanket";
...
export default function AddBlanketDialog({
  open,
  handleClose,
  dispatch,
  successNotify,
  ...
  const submitForm = async (data, e) => {
    try {
      ...
      await dispatch(addBlanket(formData));
      handleClose();
      successNotify("Thêm chăn thành công!");
      resetInput();
    } catch (error) {
      ...
      if (error?.response?.data) {
        ...
        errorNotify("Đã xảy ra lỗi không xác định.");
      }
